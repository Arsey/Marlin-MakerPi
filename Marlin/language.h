...
#elif MOTHERBOARD == 777
    #define MACHINE_NAME "Ultimaker"
    #define FIRMWARE_NAME "Marlin MakerPi (based on Marlin V1)"
    #define FIRMWARE_URL "https://github.com/TheCluster/Marlin-MakerPi/"
#else
...
// Please note these are limited to 17 characters!
	...
	#define MSG_MOVE_X                          "Ось X"
	#define MSG_MOVE_Y                          "Ось Y"
	#define MSG_MOVE_Z                          "Ось Z"
	#define MSG_MOVE_E                          "Экструдер 1"
	#define MSG_MOVE_E1 						"Экструдер 2"
	#define MSG_MOVE_E2 						"Экструдер 3"
	#define MSG_MOVE_01MM                       "Шаг 0.1mm"
	#define MSG_MOVE_1MM                        "Шаг 1mm"
	#define MSG_MOVE_10MM                       "Шаг 10mm"
	#define MSG_SPEED							"Скорость:"
	#define MSG_NOZZLE							"\002 Сопло 1:"
	#define MSG_NOZZLE1							"\002 Сопло 2:"
	#define MSG_NOZZLE2							"\002 Сопло 3:"
	#define MSG_BED								"\002 Платформа:"
...
// Serial Console Messages
	...
	#define MSG_BROWNOUT_RESET					" Сброс при пониженном питании"
	...
	#define MSG_ERR_LINE_NO						"Номер строки это не последняя строка+1, последняя строка:"
	...
	#define MSG_ERR_NO_THERMISTORS				"Отсутствует термистор"
	#define MSG_M109_INVALID_EXTRUDER			"M109 ошибка экструдера "
	#define MSG_HEATING							"Нагрев...  "
	#define MSG_HEATING_COMPLETE				"Наргето.    "
	#define MSG_BED_HEATING						"Нагрев платформы...     "
	#define MSG_BED_DONE						"Платформа нагрета.        "
	#define MSG_M115_REPORT						"FIRMWARE_NAME:" FIRMWARE_NAME " FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
	#define MSG_COUNT_X							" Count X:"
	...
	#define MSG_ERR_COLD_EXTRUDE_STOP			" защита от холодной экструзии"
	#define MSG_ERR_LONG_EXTRUDE_STOP			" защита превышения длины экструзии"
	#define MSG_BABYSTEPPING_X "Babystepping X"
	#define MSG_BABYSTEPPING_Y "Babystepping Y"
	#define MSG_BABYSTEPPING_Z "Babystepping Z"
	#define MSG_SERIAL_ERROR_MENU_STRUCTURE "Ошибка меню"
